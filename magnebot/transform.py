...
class Transform:
    ...
    def __init__(self, position: np.array, rotation: np.array, forward: np.array):
        ...
        """:field
        The position of the object as a numpy array: `[x, y, z]` The position of each object is the bottom-center point of the object. The position of each Magnebot body part is in the exact center of the body part. `y` is the up direction.
        """
